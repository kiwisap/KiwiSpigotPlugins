...
import nl.itz_kiwisap_.spigot.nms.v1_18_R2.ObfuscatedNames_v1_18_R2;
...
public final class KClientboundPacketEntityMetadata_v1_18_R2 implements KClientboundPacketEntityMetadata {

    private static final JavaReflections.FieldAccessor<List<SynchedEntityData.DataItem<?>>> METADATA_FIELD;

    static {
        METADATA_FIELD = JavaReflections.getField(ClientboundSetEntityDataPacket.class, List.class, ObfuscatedNames_v1_18_R2.METADATA_PACKET_METADATA_FIELD);
    }
    ...
    public KClientboundPacketEntityMetadata_v1_18_R2(ClientboundSetEntityDataPacket packet) {
        this.packet = packet;
