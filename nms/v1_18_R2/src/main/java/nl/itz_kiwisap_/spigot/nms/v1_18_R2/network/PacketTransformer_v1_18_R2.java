...
import nl.itz_kiwisap_.spigot.nms.v1_18_R2.network.clientbound.KClientboundPacketEntityMetadata_v1_18_R2;
...
public final class PacketTransformer_v1_18_R2 implements PacketTransformer {
    ...
    public KClientboundPacketEntityMetadata transformEntityMetadata(Object packetObject) {
        if (packetObject instanceof ClientboundSetEntityDataPacket packet) {
            return new KClientboundPacketEntityMetadata_v1_18_R2(packet);
        }
