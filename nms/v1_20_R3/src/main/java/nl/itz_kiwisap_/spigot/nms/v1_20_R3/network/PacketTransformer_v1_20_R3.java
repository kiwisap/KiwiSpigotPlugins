package nl.itz_kiwisap_.spigot.nms.v1_20_R3.network;
...
import nl.itz_kiwisap_.spigot.nms.v1_20_R3.network.clientbound.KClientboundPacketEntityMetadata_v1_20_R3;
import nl.itz_kiwisap_.spigot.nms.v1_20_R3.network.clientbound.KClientboundPacketSpawnEntity_v1_20_R3;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;

public final class PacketTransformer_v1_20_R3 implements PacketTransformer {
    ...
    public KClientboundPacketSpawnEntity transformSpawnEntity(Object bundlePacketObject, Object packetObject) {
        if (packetObject instanceof ClientboundAddEntityPacket packet) {
            ...
            return new KClientboundPacketSpawnEntity_v1_20_R3(bundlePacket, packet);
        }
    ...
    public KClientboundPacketEntityMetadata transformEntityMetadata(Object bundlePacketObject, Object packetObject) {
        if (packetObject instanceof ClientboundSetEntityDataPacket packet) {
            ClientboundBundlePacket bundlePacket = bundlePacketObject instanceof ClientboundBundlePacket bundle ? bundle : null;
            return new KClientboundPacketEntityMetadata_v1_20_R3(bundlePacket, packet);
        }
