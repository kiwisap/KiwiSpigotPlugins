...
import nl.itz_kiwisap_.spigot.common.utils.ProtocolVersion;
import nl.itz_kiwisap_.spigot.nms.KiwiNMS;
import nl.itz_kiwisap_.spigot.nms.v1_16_R3.KiwiNMS_v1_16_R3;
import nl.itz_kiwisap_.spigot.nms.v1_17_R1.KiwiNMS_v1_17_R1;
import nl.itz_kiwisap_.spigot.nms.v1_18_R2.KiwiNMS_v1_18_R2;
import nl.itz_kiwisap_.spigot.nms.v1_19_R3.KiwiNMS_v1_19_R3;
import nl.itz_kiwisap_.spigot.nms.v1_20_R1.KiwiNMS_v1_20_R1;
import nl.itz_kiwisap_.spigot.nms.v1_20_R3.KiwiNMS_v1_20_R3;
...
final class KiwiNMSInitializer {
    ...
    static void initialize() throws Exception {
        ...
        KiwiNMS instance = switch (ProtocolVersion.getServerVersion()) {
            ...
            case MINECRAFT_1_20_4 -> new KiwiNMS_v1_20_R3();
            default ->
